<aside class="main-sidebar sidebar-dark-primary elevation-4" style="background:#242A61">
    ...
    <nav class="mt-2">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            @if (Auth::user()->jabatan == User::TIM_SPK_ROLE || Auth::user()->jabatan == User::ADMIN_ROLE)
                <li class="nav-item">
            ...
            @endif
            @if (Auth::user()->jabatan == User::ADMIN_ROLE || Auth::user()->jabatan == User::TIM_SPK_ROLE)
                <li class="nav-item">
            ...
            @endif
            <li class="nav-item">
                <a href="{{ Auth::user()->jabatan == User::TIM_SPK_ROLE ? route('hasil.akhir') : route('hasil.akhir.generated.view') }}"
                    class="nav-link">
